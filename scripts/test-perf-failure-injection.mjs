...
const cases = [
  { name: 'good-fixture-passes', setup: () => {}, expectPass: true },
  {
    ...
    // Must track BUDGETS.cssTotal in check-perf.mjs (130KB as of
    // 2026-09-26, EV-20260926-007): a fixture under the current budget
    // would pass and the case would silently stop proving anything.
    setup: (w) => w('big.css', 'x'.repeat(131 * 1024)),
    expectPass: false,
